      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=6">Import Quiz</a></li>
...
echo '
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Import quiz</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form enctype="multipart/form-data" class="form-horizontal title1" name="form" action="update.php?q=importquiz"  method="POST">
<fieldset>
...
<!-- File input-->
<div class="form-group">
  <label class="col-md-12" for="file">Question file input (.doc,.docx)</label>
  <div class="col-md-12">
...
<div class="form-group">
  <label class="col-md-12 control-label" for=""></label>
  <div class="col-md-12">
    <button type="submit" class="btn btn-primary" class="btn btn-primary" style="margin-left:45%">Submit</button>
  </div>
</div>
